...
namespace Classier.NET.Parsing
{
    ...
    public sealed class ClassierTokenCollection : IEnumerable<ClassierTokenDefinition>
    {
        ...
        public IEnumerator<ClassierTokenDefinition> GetEnumerator()
        {
            ...
            yield return new RegexTokenDefinition<ClassierTokenType>(ClassierTokenType.CommentEnd, "\\/\\*");
            yield return new RegexTokenDefinition<ClassierTokenType>(ClassierTokenType.CommentStart, "\\*\\/");
            ...
            yield return new RegexTokenDefinition<ClassierTokenType>(ClassierTokenType.Keyword, "abstract|get|mutable|override|set|var|virtual|void");
            yield return new RegexTokenDefinition<ClassierTokenType>(ClassierTokenType.Keyword, "if|new|null|super|using|while");
            ...
            yield return new RegexTokenDefinition<ClassierTokenType>(ClassierTokenType.Operator, "(\\|\\|)|&&"); // Boolean operators
